...
2. Create AT LEAST 10 epics.
3. Create AT LEAST 10 stories per epic.
4. Identify AT LEAST 10 risks.
5. Identify AT LEAST 10 assumptions.
...
2.1 Epic count  
- At least 10 epics, numbered sequentially: EPIC-001 … EPIC-010+.
...
2.4 Epic structure  
- EVERY epic must contain at least 10 stories.  
...
4.4 At least 3 risks must reference technical uncertainty.  
4.5 At least 3 risks must reference product or requirements uncertainty.

=======================
5) RULES FOR assumptions
=======================

5.1 Minimum 10 assumptions.  
